  ...
  return (
    ...
    <h2 className="text-center mb-4">Danh Mục Nổi Bật</h2>
      ...
      <Carousel className="mb-4">
        <Carousel.Item>
          <Image className="d-block w-100" src={require("../assets/image/banner/banner_1.jpg")} alt="Slide 1" fluid />
        </Carousel.Item>
        <Carousel.Item>
          <Image className="d-block w-100" src={require("../assets/image/banner/banner_2.jpg")} alt="Slide 2" fluid />
        </Carousel.Item>
        <Carousel.Item>
          <Image className="d-block w-100" src={require("../assets/image/banner/banner_3.jpg")} alt="Slide 3" fluid />
        </Carousel.Item>
        <Carousel.Item>
          <Image className="d-block w-100" src={require("../assets/image/banner/banner_4.jpg")} alt="Slide 4" fluid />
        </Carousel.Item>
      </Carousel>

      <Tabs defaultActiveKey="profile" id="fill-tab-example" className="mb-20 mt-20"
        fill
      >
